...
SELECT COUNT(staff_id) AS number_of_employes FROM staff;

# 5.3 Determine how many films are available for rent and how many have been rented.
SELECT COUNT(*) AS available_for_rent
FROM rental;

SELECT COUNT(*) AS have_been_rented
FROM inventory;
...
SELECT * FROM film where description Like "Behind the Scenes content";