...
SELECT distinct sakila.actor.last_name from sakila.actor;
SELECT COUNT(distinct sakila.actor.last_name) from sakila.actor;

/*6. Retrieve the 10 longest films.*/

SELECT * FROM sakila.film order by sakila.film.length desc
LIMIT 10;
...
SELECT * FROM sakila.film WHERE special_features LIKE '%behind%';
