...
SELECT 
    SUM(CASE WHEN return_date IS NOT NULL THEN 1 ELSE 0 END) AS Avaliable,
...
-- %texto -> De 0 a N caracteres antes de texto
-- _texto -> Exactamente 1 caracter antes de texto
