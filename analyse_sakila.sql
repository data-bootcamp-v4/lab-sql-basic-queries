...
-- 3.3 List of languages used in films, with the column aliased as language from the language table
...
-- 5.3.1 Amount of films available for rent
SELECT COUNT(*) AS available_films FROM film;
-- 5.3.2 Amount of films rented
